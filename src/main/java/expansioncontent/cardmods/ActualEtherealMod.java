...
/**
 * Ethereal from hit game slay the spire.
 * With no jank or weird workarounds.
 * Use this in place of other weird nonsense.
 */
public class ActualEtherealMod extends AbstractCardModifier {
    public static String ID = "downfall:ActualEtherealMod";
